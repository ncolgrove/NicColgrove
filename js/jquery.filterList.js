...
function filterlist(selectobj) {
  ...
  this.init = function() {
	...
	*/
	...
	//this.optionscopy = new Array();
	/*
	this.optionscopy = new Object;
	
	
	$( "#thelist li" ).each(function( index ) {
		if($(this).attr("id")){
			alert($(this).attr("id"));
			this.optionscopy[ $(this).attr("id") ] = ""; // $(this).attr("sortVal");
			console.log( this.optionscopy );
		}
	});
	*/
  ...
  this.set = function(pattern) {
	...
	$( "#sortList .sortItem" ).each(function( index ) {
		if($(this).attr("data-filter_Primary")){


 
			  if (
			  	  ($(this).hasClass('active')  ) ||
			  	  ($(this).attr("data-filter_Primary") && regexp.test(  $(this).attr("data-filter_Primary")  )) ||
				  ($(this).attr("filter_Secondary") && regexp.test(  $(this).attr("filter_Secondary")  ))
				  ) {
